    ...
    <div class="container_">
      ...
      <div id="gallery-wrapper" class="flex items-center flex-wrap">
        <div v-for="(item, idx) in work" :key="idx" class="picture-item w-full p-3 xl:w-1/3">
          <div class="group space-y-6 overflow-hidden rounded-lg bg-default-200 p-1 h-[370px]">
            <div class="relative overflow-hidden rounded-lg">
              <img
                class="transition mx-auto h-[250px] w-full object-cover object-top duration-500 group-hover:scale-105"
                :src="item.images[0]"
                alt=""
                loading="lazy"
                :width="640"
                ...
                <div class="h-full w-full rounded bg-black/10">
                  <div class="flex h-full items-end p-4">
                    <div class="overflow-hidden">
                      ...
                      <h5 class="mb-2 text-1xl font-medium text-white">
                        {{ item.title }}
                      </h5>
                      <p
